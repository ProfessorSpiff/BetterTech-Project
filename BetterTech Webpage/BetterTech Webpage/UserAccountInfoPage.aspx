<%@ Page Title="" Language="C#" MasterPageFile="~/BetterTech.Master" AutoEventWireup="true" CodeBehind="UserAccountInfoPage.aspx.cs" Inherits="BetterTech_Webpage.InvoicesPage" %>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <div class="my-account-content" id="accordion2">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion2" href="#My_order_info">Invoices History</a>
                                        </h4>
                                    </div>
